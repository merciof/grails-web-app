...
var FeelingReportComponent = /** @class */ (function () {
    function FeelingReportComponent(http, userService) {
        this.http = http;
        this.userService = userService;
        this.happyCount = 0;
        this.unhappyCount = 0;
        ...
        this.feelings = [];
        // Pie
        this.pieChartLabels = ['Feliz', 'Triste', 'Bravo', 'Confuso'];
        this.pieChartData = [10, 10];
        this.pieChartType = 'pie';
    }
    FeelingReportComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    FeelingReportComponent.prototype.loadData = function () {
        var _this = this;
        this.userService.listStudents().subscribe(function (user) { return user.map(function (user) {
            _this.feelings.push(user.feeling);
        }); });
        // this.http.get<User[]>('http://minhaturma.herokuapp.com/api/user/student').
        // subscribe(e => e.map(item => this.feelings.push(item.feeling)));
    };
    FeelingReportComponent.prototype.happyCountMethod = function () {
        for (var i = 0; i < this.feelings.length; i = i + 1) {
            if (this.feelings[i] === 'Happy') {
                this.happyCount = this.happyCount + 1;
            }
            else if (this.feelings[i] === 'Unhappy') {
                this.unhappyCount = this.unhappyCount + 1;
            }
            else if (this.feelings[i] === 'Confused') {
                this.confusedCount = this.confusedCount + 1;
            }
            else if (this.feelings[i] === 'Mad') {
                this.madCount = this.madCount + 1;
            }
        }
    };
    // events
    FeelingReportComponent.prototype.chartClicked = function (e) {
        ...
        this.pieChartData.push(this.happyCount, this.unhappyCount, this.madCount, this.confusedCount);
    };
    ...
    FeelingReportComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
            _users_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])
...
var PresenceReportComponent = /** @class */ (function () {
    function PresenceReportComponent(userService, http) {
        this.userService = userService;
        this.http = http;
        // lineChart
        this.lineChartData = [
            { data: [3, 5, 2, 8], label: 'Número de alunos por aula' }
            // {data: [28, 48, 40, 19, 86, 27, 90, 28, 48, 40, 19, 86 ], label: 'Turma B'},
            // {data: [18, 48, 77, 9, 100, 27, 40, 18, 48, 77, 9, 100 ], label: 'Turma C'}
        ];
        this.lineChartLabels = ['2019-02-20', '2019-02-21', '2019-02-22', '2019-02-22'];
    ...
    PresenceReportComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    PresenceReportComponent.prototype.loadData = function () {
        // this.http.get<Lecture[]>('http://minhaturma.herokuapp.com/api/lecture/').
        // subscribe(e => e.map(item => this.dates.push(item.date)) );
    };
    ...
    PresenceReportComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_users_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"],
